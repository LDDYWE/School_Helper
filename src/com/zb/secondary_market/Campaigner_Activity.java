...
public class Campaigner_Activity extends FragmentActivity implements
		OnClickListener {
	private static final String TAG = "Campaigner_Activity";
	...
	private Campaigner_Mainpage_Fragment fragmentPage1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_compaigner);
	...
	private void initData() {
		...
		// 给按钮图片设置监听
//		toggleImageView = (ImageView) findViewById(R.id.toggle_btn_temperary_campaigner);
...
//		case R.id.toggle_btn_temperary_campaigner:
//			clickToggleBtn();
//			break;
		}
	}
	...
	public void Replace_mainpagefragment() {
		// 实例化Fragment页面
		fragmentPage1 = new Campaigner_Mainpage_Fragment();
		// 得到Fragment事务管理器
		FragmentTransaction fragmentTransaction = this
				.getSupportFragmentManager().beginTransaction();
		// 替换当前的页面
		fragmentTransaction.replace(R.id.frame_content_temperary_campaigner,
				fragmentPage1);
		// 事务管理提交
	...
	private void clickToggleBtn() {
		...
		intent.setClass(Campaigner_Activity.this, Campaigner_PhotoGraph_Activity.class);
