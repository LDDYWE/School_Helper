...
public class AsynImageLoader_refresh {  
...
//    private Bitmap mmBitmap;
    ...
    private final static String ALBUM_PATH = Environment.getExternalStorageDirectory() + "/xiaoyuanzhushou_headphoto/";
      
    public AsynImageLoader_refresh(String nickname){ 
    	this.nicknameString = nickname;
        // 初始化变量  
    	//这一caches怎么保证里面的东西不消失
//        caches = new HashMap<String, SoftReference<Bitmap>>();  
        taskQueue = new ArrayList<AsynImageLoader_refresh.Task>();  
        // 启动图片下载线程  
        isRunning = true;  
...
//                dirFile.mkdir();  
//            } */ 
//            File myCaptureFile = new File(ALBUM_PATH + nicknameString); 
//            if (myCaptureFile.exists()) {
//            	Log.v(TAG + "SD卡中获取", "success");
//            	//这里加上判断：如果是第一次，就decode，如果不是第一次，就直接return
//            	
//                BitmapFactory.Options options = new BitmapFactory.Options();
//                options.inJustDecodeBounds = true;
//                // 获取这个图片的宽和高
//                Bitmap bitmap=BitmapFactory.decodeFile(ALBUM_PATH + nicknameString, options);
...
//                bitmap=BitmapFactory.decodeFile(ALBUM_PATH + nicknameString,options);
//                int w = bitmap.getWidth();
//                int h = bitmap.getHeight();
    ...
    private ImageCallback getImageCallback(final ImageView imageView, final int resId){  
        return new ImageCallback() {  
            ...
            public void loadImage(String path, Bitmap bitmap) {
            	...
            	Log.v(TAG + "imageView.getTag().toString()", imageView.getTag().toString() + "");
            	Log.v(TAG + "path", path + "");
