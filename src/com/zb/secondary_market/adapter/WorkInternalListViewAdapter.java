...
public class WorkInternalListViewAdapter extends BaseAdapter {
	private static final String TAG = "WorkInternerListViewAdapter";
	...
	public WorkInternalListViewAdapter(ImageFetcher imageFetcher, FragmentActivity mActivity,
...
//				.findViewById(R.id.id_fragment_assortment_variety_listview_item_ll_work_ll_nickname_withtitle);
		discription = (TextView)convertView.findViewById(R.id.id_work_ll2_content);
//		type = (TextView) convertView
//				.findViewById(R.id.id_fragment_assortment_variety_listview_item_ll_ll_type_work_withtitle);
...
//		type.setText((dataDetails.get(position).getType().equals(""))?"未知":dataDetails.get(position).getType());
