...
public class SchoolActivityListViewAdapter extends BaseAdapter {
	private static final String TAG = "SchoolActivityListViewAdapter";
	...
	public SchoolActivityListViewAdapter(ImageFetcher imageFetcher,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = inflater.inflate(R.layout.school_list_item_activity,
		...
		icon = (ImageView) convertView
				.findViewById(R.id.id_school_activity_imageview);
		...
		name = (TextView) convertView.findViewById(R.id.id_school_activity_textView);
		
		name.setWidth(para.width);
		...
		// .findViewById(R.id.id_school_content);
		...
		// .findViewById(R.id.id_school_ll_datetime);

		mImageFetcher.loadImage(dataDetails.get(position).getImageurl(), icon);
...
//		Matcher matcher_detail = patt_detail.matcher(dataDetails.get(position)
//				.getContent());
//
//		while (matcher_detail.find()) {
//			System.out.println("您输入的HTML地址正确"); //
//			System.out.println(matcher_detail.group(1));
//			discription.setText((matcher_detail.group(1).equals("")) ? "未知"
//					: matcher_detail.group(1));
//		}

		// discription
		// .setText((dataDetails.get(position).getContent().equals("")) ? "未知"
		// : dataDetails.get(position).getContent());
		// nickname.setText((dataDetails.get(position).getNickname().equals(""))
		// ? "未知"
...
//		datatime.setText((dataDetails.get(position).getDataTime().equals("")) ? "未知"
//				: dataDetails.get(position).getDataTime());

		Log.v(TAG, "fuckfuckfuck");

		// String datetimeString = dataDetails.get(position).getDataTime()
		// .split("-")[0]
		// + "-"
		// + dataDetails.get(position).getDataTime().split("-")[1]
		// + "-" + dataDetails.get(position).getDataTime().split("-")[2];
