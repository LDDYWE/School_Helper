 ...
 */
public class AlbumCampaignerActivity extends Activity {
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(AlbumCampaignerActivity.this, GalleryCampaignerActivity.class);
...
//				Log.v("XXXXXXXXXXXXXXXXXXXXX", "secondary");
				intent.setClass(AlbumCampaignerActivity.this,
...
//			}
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			intent.setClass(AlbumCampaignerActivity.this, ImageFileCampaignerActivity.class);
			startActivity(intent);
		}
	}
	 ...
	 * Campaigner_PhotoGraph_Activity.class); startActivity(intent); finish(); }
	 * }
	 */
...
//		back.setOnClickListener(new BackListener());
		...
		okButton.setText(Res.getString("finish") + "("
				+ Bimp.tempSelectBitmap.size() + "/" + PublicWay.num_campaigner + ")");
	}
		...
		gridImageAdapter
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num_campaigner) {
							toggleButton.setChecked(false);
							chooseBt.setVisibility(View.GONE);
							if (!removeOneData(dataList.get(position))) {
								Toast.makeText(AlbumCampaignerActivity.this,
