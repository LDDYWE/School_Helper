 ...
 */
public class ShowAllPhotoSecondaryActivity extends Activity {
		...
		showallimage_titleView.setTextLeftButton("相册",
				new OnTextLeftButtonClickListener() {
					...
					public void onClick(View TextView) {
						...
						intent.setClass(ShowAllPhotoSecondaryActivity.this,
...
//				finish();
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num
							...
							Toast.makeText(ShowAllPhotoSecondaryActivity.this,
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			this.finish();
			intent.setClass(ShowAllPhotoSecondaryActivity.this, ImageFileSecondaryActivity.class);
			startActivity(intent);
		}
