...
import com.zb.secondary_market.adapter.FriendMainpageListViewAdapter;
...
public class Friend_Mainpage_Fragment extends Fragment {
	private static final String TAG = "Friend_Mainpage_Fragment";
...
//	private TitleView mTitle;
	...
	private ListView friendmainpageListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private FriendMainpageListViewAdapter friendMainpageListViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/friend";
	private String url =  UsefulString.urlString + "friend";
...
//				.findViewById(R.id.pull_friend_mainpage_title);
//
//		mTitle.setLayoutParams(LayoutParams.MATCH_PARENT, tabheight);
//		mTitle.setTitle("校园交友");
//
...
//		mTitle.setImageRightButton(R.drawable.edit,
...
//				});
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_friend_mainpage);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_friend_mainpage);
		...
		friendmainpageListView = mPullToRefreshListView.getRefreshableView();
			...
			if (item_detail_List.size() == 0) {
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							friendMainpageListViewAdapter = new FriendMainpageListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							friendmainpageListView
									.setAdapter(friendMainpageListViewAdapter);
							friendmainpageListView
					...
					friendMainpageListViewAdapter.notifyDataSetChanged();
				}
			}
