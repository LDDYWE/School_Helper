...
import com.zb.secondary_market.adapter.SecondaryMeReleasedGridViewAdapter;
...
public class Secondary_Other_Released_Fragment extends Fragment {
	private static final String TAG = "Secondary_Other_Released_Fragment";
	private static final String IMAGE_CACHE_DIR = "thumbs_high";

	private FragmentActivity mActivity;
	private View mParent;
	private int tabheight = 0;
	private GridView secondary_other_releasedGridView;
	private SecondaryMeReleasedGridViewAdapter secondary_other_releasedGridViewAdapter;
	private TextView textView;

	private List<Item_Detail> item_detail_List = new ArrayList<Item_Detail>();

	private PullToRefreshGridView_1 mPullRefreshGridView;
...
//	private String url = "http://222.195.78.112:8000/myinfo";
	...
	public Secondary_Other_Released_Fragment(String other_vid) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_secondary_other_released, null);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mPullRefreshGridView = (PullToRefreshGridView_1) mParent
				.findViewById(R.id.id_fragment_secondary_other_released_tt_pull_refresh_gv);
		textView = (TextView) mParent
				.findViewById(R.id.id_fragment_secondary_other_released_tt);
		...
		secondary_other_releasedGridView = mPullRefreshGridView
				.getRefreshableView();
		
		secondary_other_releasedGridView.setHorizontalSpacing(5);
		secondary_other_releasedGridView.setVerticalSpacing(5);
	...
	private class DownloadVodInfo extends
		...
		protected List<Item_Detail> doInBackground(String... params) {
			...
			try {
				...
				jsonContent = getHtmlContent(params[0] + "?vid=" + other_vid + "&type=second" + "&page="
						+ loadjson_page, "utf-8");
			...
			if (item_detail_List.size() == 0) {
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							secondary_other_releasedGridViewAdapter = new SecondaryMeReleasedGridViewAdapter(
									mImageFetcher, getActivity(),
									content_item_height, item_detail_list);
							secondary_other_releasedGridView
									.setAdapter(secondary_other_releasedGridViewAdapter);
							secondary_other_releasedGridView
					...
					secondary_other_releasedGridViewAdapter.notifyDataSetChanged();
				}
			}
