...
import com.zb.secondary_market.adapter.CampaignerMainpageListViewAdapter;
...
public class Campaigner_Mainpage_Fragment extends Fragment {
	private static final String TAG = "Campaigner_Mainpage_Fragment";
	...
	private ListView compaignermainpageListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private CampaignerMainpageListViewAdapter campaignerMainpageListViewAdapter;
	...
	private String url = UsefulString.urlString + "activity";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_campaigner, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		// layout.findViewById(R.id.id_slidemenu);
		//
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_campaigner_mainpage);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_campaigner_mainpage);
		...
		compaignermainpageListView = mPullToRefreshListView
				.getRefreshableView();
	 ...
	 * 
	 * item_detail.setDataTime(data2.getString("datatime"));
	 * 
	...
	public void JsonDeal(String jsonContent) {
		try {
			...
			for (int i = 0; i < page.length(); i++) {
				...
				item_detail.setPlace(data2.getString("place"));
			...
			if (item_detail_List.size() == 0) {
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							campaignerMainpageListViewAdapter = new CampaignerMainpageListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							compaignermainpageListView
									.setAdapter(campaignerMainpageListViewAdapter);
							compaignermainpageListView
					...
					campaignerMainpageListViewAdapter.notifyDataSetChanged();
				}
			}
