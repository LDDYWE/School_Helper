...
import com.zb.secondary_market.adapter.WorkInternalListViewAdapter;
...
public class Work_Internal_Fragment extends Fragment {
	private static final String TAG = "Work_Interner_Fragment";
...
//	private TitleView mTitle;
	...
	private ListView workInternalListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private WorkInternalListViewAdapter workInternalListViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/internal";
	private String url =  UsefulString.urlString + "internal";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_work_internal, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		/*mTitle = (TitleView) mParent
				.findViewById(R.id.pull_work_internal_title);

		mTitle.setLayoutParams(LayoutParams.MATCH_PARENT, tabheight);
		mTitle.setTitle("实习信息");
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_work_internal);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_work_internal);
		...
		workInternalListView = mPullToRefreshListView.getRefreshableView();
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							...
							workInternalListViewAdapter = new WorkInternalListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							workInternalListView
									.setAdapter(workInternalListViewAdapter);
							workInternalListView
					...
					workInternalListViewAdapter.notifyDataSetChanged();
				}
			}
