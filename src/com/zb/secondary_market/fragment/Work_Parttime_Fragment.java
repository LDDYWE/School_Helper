...
import com.zb.secondary_market.adapter.WorkParttimeListViewAdapter;
...
public class Work_Parttime_Fragment extends Fragment {
	private static final String TAG = "Work_Parttime_Fragment";
...
//	private TitleView mTitle;
	...
	private ListView workParttimeListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private WorkParttimeListViewAdapter workParttimeListViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/parttime";
	private String url =  UsefulString.urlString + "parttime";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_work_parttime, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		/*mTitle = (TitleView) mParent
				.findViewById(R.id.pull_work_parttime_title);

		mTitle.setLayoutParams(LayoutParams.MATCH_PARENT, tabheight);
		mTitle.setTitle("兼职信息");
...
//							mActivity.finish();
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_work_parttime);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_work_parttime);
		...
		workParttimeListView = mPullToRefreshListView.getRefreshableView();
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							...
							workParttimeListViewAdapter = new WorkParttimeListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							workParttimeListView
									.setAdapter(workParttimeListViewAdapter);
							workParttimeListView
					...
					workParttimeListViewAdapter.notifyDataSetChanged();
				}
			}
