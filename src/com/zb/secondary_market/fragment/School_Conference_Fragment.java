...
import com.zb.secondary_market.adapter.SchoolConferenceListViewAdapter;
...
public class School_Conference_Fragment extends Fragment {
	private static final String TAG = "School_Conference_Fragment";
...
//	private TitleView mTitle;
	...
	private ListView schoolConferenceListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private SchoolConferenceListViewAdapter schoolConferenceListViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/conference";
	private String url =  UsefulString.urlString + "conference";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_school_conference, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		/*mTitle = (TitleView) mParent
				.findViewById(R.id.pull_school_conference_title);

		mTitle.setLayoutParams(LayoutParams.MATCH_PARENT, tabheight);
		mTitle.setTitle("会议信息");
...
//							mActivity.finish();
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_school_conference);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_school_conference);
		...
		schoolConferenceListView = mPullToRefreshListView.getRefreshableView();
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							...
							schoolConferenceListViewAdapter = new SchoolConferenceListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							schoolConferenceListView
									.setAdapter(schoolConferenceListViewAdapter);
							schoolConferenceListView
					...
					schoolConferenceListViewAdapter.notifyDataSetChanged();
				}
			}
