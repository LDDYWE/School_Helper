...
public class Secondary_Mainpage_Fragment extends Fragment {
	...
	// private String url = "http://222.195.78.112:8000/second";
	private String url = UsefulString.urlString + "second";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_secondary, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		// .findViewById(R.id.pull_secondary_mainpage_title);
		...
		textView = (TextView) mParent.findViewById(R.id.pull_null_text);
		...
		mainpageGridView = new CustomGridView(mActivity);
		mainpageGridView = mPullRefreshGridView.getRefreshableView();

		// 此处设置listview或者gridview中item之间间距
		mainpageGridView.setHorizontalSpacing(5);
		mainpageGridView.setVerticalSpacing(5);
