...
import com.zb.secondary_market.adapter.SchoolActivityListViewAdapter;
...
public class School_Activity_Fragment extends Fragment {
	private static final String TAG = "School_Activity_Fragment";
...
//	private TitleView mTitle;
	...
	private ListView schoolActivityListView;
	// private MainpageGridViewAdapter mainpageGridViewAdapter;
	private SchoolActivityListViewAdapter schoolActivityListViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/poster";
	private String url =  UsefulString.urlString + "poster";
	...
	public View onCreateView(LayoutInflater inflater,
		...
		return inflater.inflate(R.layout.fragment_school_activity, null);
	}
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		/*mTitle = (TitleView) mParent
				.findViewById(R.id.pull_school_activity_title);

		mTitle.setLayoutParams(LayoutParams.MATCH_PARENT, tabheight);
		mTitle.setTitle("活动信息");
...
//							mActivity.finish();
		...
		mPullToRefreshListView = (PullToRefreshListView) mParent
				.findViewById(R.id.pull_refresh_list_school_activity);
		textView = (TextView) mParent
				.findViewById(R.id.pull_null_text_school_activity);
		...
		schoolActivityListView = mPullToRefreshListView.getRefreshableView();
...
//				item_detail.setVid(data2.getString("vid"));
				...
				item_detail.setImagerul(data2.getString("image"));
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							...
							schoolActivityListViewAdapter = new SchoolActivityListViewAdapter(
									mImageFetcher, getActivity(),
									// content_item_height,
									item_detail_list);
							schoolActivityListView
									.setAdapter(schoolActivityListViewAdapter);
							schoolActivityListView
...
//										startActivity(in);
					...
					schoolActivityListViewAdapter.notifyDataSetChanged();
				}
			}
