...
public class Secondary_Me_Released_Fragment extends Fragment {
	private static final String TAG = "Secondary_Me_Released_Fragment";
	private static final String IMAGE_CACHE_DIR = "thumbs_high";

	private FragmentActivity mActivity;
	private View mParent;
	private int tabheight = 0;
	private GridView secondary_me_releasedGridView;
	private SecondaryMeReleasedGridViewAdapter secondary_me_releasedGridViewAdapter;
...
//	private String url = "http://222.195.78.112:8000/myinfo";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_secondary_me_released, null);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mPullRefreshGridView = (PullToRefreshGridView) mParent
				.findViewById(R.id.id_fragment_secondary_me_released_tt_pull_refresh_gv);
		textView = (TextView) mParent
				.findViewById(R.id.id_fragment_secondary_me_released_tt);
		...
		secondary_me_releasedGridView = mPullRefreshGridView
				.getRefreshableView();
		
		secondary_me_releasedGridView.setHorizontalSpacing(5);
		secondary_me_releasedGridView.setVerticalSpacing(5);
	...
	private class DownloadVodInfo extends
		...
		protected List<Item_Detail> doInBackground(String... params) {
			...
			try {
				...
				jsonContent = getHtmlContent(params[0] + "?vid=" + vidString + "&type=second" + "&page="
						+ loadjson_page, "utf-8");
			...
			if (item_detail_List.size() == 0) {
				...
				if (loadjson_page == 1) {
					...
					if (isfirst == false) {
						...
						if (isupdated == true) {
							secondary_me_releasedGridViewAdapter = new SecondaryMeReleasedGridViewAdapter(
									mImageFetcher, getActivity(),
									content_item_height, item_detail_list);
							secondary_me_releasedGridView
									.setAdapter(secondary_me_releasedGridViewAdapter);
							secondary_me_releasedGridView
					...
					secondary_me_releasedGridViewAdapter.notifyDataSetChanged();
				}
			}
