 ...
 */
public class AlbumFriendActivity extends Activity {
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(AlbumFriendActivity.this, GalleryFriendActivity.class);
...
//				Log.v("XXXXXXXXXXXXXXXXXXXXX", "secondary");
				intent.setClass(AlbumFriendActivity.this,
...
//			}
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			intent.setClass(AlbumFriendActivity.this, ImageFileFriendActivity.class);
			startActivity(intent);
		}
	}
	 ...
	 * Friend_PhotoGraph_Activity.class); startActivity(intent); finish(); }
	 * }
	 */
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
							...
							if (!removeOneData(dataList.get(position))) {
								Toast.makeText(AlbumFriendActivity.this,
