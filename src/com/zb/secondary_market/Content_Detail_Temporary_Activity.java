...
public class Content_Detail_Temporary_Activity extends Activity implements
		OnClickListener {
	private static final String TAG = "Content_Detail_Temporary_Activity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_content_detail_temporary);
		...
		String log_infoString = vidString + "*" + nicknameString + "*" + "校园二手"
	...
	public void titleViewInit(String typeString) {
		...
		contenTitleView = (TitleView) findViewById(R.id.id_detail_content_title_temporary);
		detail_title = (TextView) findViewById(R.id.id_detail_content_ll_ll1_name_temporary);
		detail_author = (TextView) findViewById(R.id.id_detail_content_ll_ll2_author_temporary);
		// detail_contentaddress = (TextView)
		// findViewById(R.id.id_detail_content_ll_ll2_content_ll_address_temporary);
		detail_contentdetail = (TextView) findViewById(R.id.id_detail_content_ll_ll2_content_ll_detail_temporary);
		// detail_contentsource = (TextView)
		// findViewById(R.id.id_detail_content_ll_ll2_content_ll_source_temporary);
		...
		// detail_contentaddress.setText(item_detail.get(position).getContentAddress());
		detail_contentdetail.setText(item_detail.getContent());
		// detail_contentsource.setText(item_detail.get(position).getContentSource());

		// detail_content.setText(item_detail.get(position).getContent());
		...
		contenTitleView.setImageLeftButton(R.drawable.arrow_left_white_thin,
				new OnImageLeftButtonClickListener() {
					...
					public void onClick(View Imagebutton) {
						...
						// 存储对象
						SharedPreferences sharedPreferences = Content_Detail_Temporary_Activity.this
		...
		/*
		 * contenTitleView.setImageRightButton(R.drawable.arrow_right, new
		 * OnImageRightButtonClickListener() {
		 * 
		 * @Override public void onClick(View Imagebutton) { // TODO
		 * Auto-generated method stub
		 * Toast.makeText(Content_Detail_Temporary_Activity.this, "选择您所想分享的平台",
