 ...
 */
public class ShowAllPhotoCampaignerActivity extends Activity {
		...
		showallimage_titleView.setTextLeftButton("相册",
				new OnTextLeftButtonClickListener() {
					...
					public void onClick(View TextView) {
						...
						intent.setClass(ShowAllPhotoCampaignerActivity.this,
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num_campaigner
							...
							Toast.makeText(ShowAllPhotoCampaignerActivity.this,
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			this.finish();
			intent.setClass(ShowAllPhotoCampaignerActivity.this, ImageFileCampaignerActivity.class);
			startActivity(intent);
		}
