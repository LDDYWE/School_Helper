...
public class Content_Detail_School_Activity extends Activity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String log_infoString = vidString + "*" + nicknameString + "*" + "校园信息—查看"
		...
		contenTitleView.setImageLeftButton(R.drawable.arrow_left_white_thin,
				new OnImageLeftButtonClickListener() {
					...
					public void onClick(View Imagebutton) {
						...
						// 存储对象
						SharedPreferences sharedPreferences = Content_Detail_School_Activity.this
		...
		/*contenTitleView.setImageRightButton(R.drawable.arrow_right,
				new OnImageRightButtonClickListener() {
					...
					public void onClick(View Imagebutton) {
						// TODO Auto-generated method stub
						Toast.makeText(
								Content_Detail_School_Activity.this,
