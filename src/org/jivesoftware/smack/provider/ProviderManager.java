...
public final class ProviderManager {
    ...
    public static List<IQProvider<IQ>> getIQProviders() {
        List<IQProvider<IQ>> providers = new ArrayList<IQProvider<IQ>>(iqProviders.size());
    ...
    public static List<ExtensionElementProvider<ExtensionElement>> getExtensionProviders() {
        List<ExtensionElementProvider<ExtensionElement>> providers = new ArrayList<ExtensionElementProvider<ExtensionElement>>(extensionProviders.size());
