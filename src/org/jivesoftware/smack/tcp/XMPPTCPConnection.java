            ...
            try {
                ...
                while (!done) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(name.equals(Message.ELEMENT)||name.equals(IQ.IQ_ELEMENT)||name.equals(Presence.ELEMENT)){
                        	try {
                        	...
                        	}else if(namespace.equals("http://jabber.org/protocol/compress")){
                        		compressSyncPoint.reportFailure(new XMPPErrorException(
                                        "Could not establish compression", null));
                        	}else if(namespace.equals(SaslStreamElements.NAMESPACE)){
                        		final SASLFailure failure = PacketParserUtils.parseSASLFailure(parser);
                                getSASLAuthentication().authenticationFailed(failure);
                        	}
                        }else if(name.equals(Challenge.ELEMENT)){
                        	String challengeData = parser.nextText();
                            getSASLAuthentication().challengeReceived(challengeData);
                        }else if(name.equals(Success.ELEMENT)){
                        ...
                        }else if(name.equals(Compressed.ELEMENT)){
                        	initReaderAndWriter();
                            // Send a new opening stream to the server
                            openStream();
