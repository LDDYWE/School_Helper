...
public class VCardManager extends Manager {
    ...
    private static final Map<XMPPConnection, VCardManager> INSTANCES = new WeakHashMap<XMPPConnection, VCardManager>();
    ...
    public void saveVCard(VCard vcard) throws NoResponseException, XMPPErrorException, NotConnectedException {
        // XEP-54 搂 3.2 "A user may publish or update his or her vCard by sending an IQ of type "set" with no 'to' address鈥�
        vcard.setTo(null);
